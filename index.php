...
<body>
    ...
    <section class="container vh-100 d-flex align-items-center">
      <div class="col-6 col-md-12">
        <div class="align-items-center">
          ...
          <h3 class="passion">Passionné</h3>
        </div>
      </div>
    </section>
  </header>
  <section id="apropos" class="bgBlue vh-75 py-5">
    <div class="container">
      <div class="row">
        ...
        <div class="social-links p-5 fs-1 d-flex align-items-center justify-content-center">
          <a href="https://twitter.com/BenoitVincent39" target="_blank" class="twitter text-white px-2"><i class="fa-brands fa-twitter"></i></a>
          <a href="https://www.instagram.com/vincent_benoit_39/" target="_blank" class="instagram text-white px-2"><i class="fa-brands fa-instagram"></i></a>
          <a href="https://github.com/VincentBenoit39" target="_blank" class="github text-white px-2"><i class="fa-brands fa-github"></i></a>
          <a href="https://www.linkedin.com/in/vincent-benoit-/" target="_blank" class="linkedin text-white px-2"><i class="fa-brands fa-linkedin-in"></i></a>
          <a href="https://discord.gg/KRAzzC2s" target="_blank" class="discord text-white px-2"><i class="fa-brands fa-discord"></i></a>
        </div>
      </div>
    </div>
    </div>
  </section>
  <section id="competences" class="py-5 bgBlue">
    <div class="container">
      <h2 class="mb-0 fs-1">Mes compétences</h2>
      <h3 class="fw-light fs-6">Développement web / Designe</h3>
      <div class="row gy-4 mt-4 text-white align-items-center">
        <div class="col-12 col-lg-6">
          ...
          <div class="d-flex justify-content-start align-items-center">
            <i class="fab fa-css3-alt fa-2x me-3"></i>
            <p class="fw-bold m-0">CSS3</p>
          </div>
          <div class="d-flex justify-content-start align-items-center">
            <i class="fab fa-js fa-2x me-3"></i>
            <p class="fw-bold m-0">JS</p>
          </div>
          <div class="d-flex justify-content-start align-items-center">
            <i class="fab fa-php fa-2x me-2 php"></i>
            <p class="fw-bold m-0">PHP</p>
          </div>
        </div>
        <div class="col-12 col-lg-6 align-items-center">
          <img src="./assets/img/designe.png" alt="image de mes compétences web" width="auto" height="auto">
        </div>
      </div>
      <!-- Design -->
      <div class="row gy-4 mt-4">
        <div class="col-12 col-lg-6 align-items-center">
          <img src="./assets/img/skills.png" alt="image de mes compétences designs" width="auto" height="auto">
        </div>
        <div class="col-12 order-first offset-md-1 col-md-6 order-md-last">
  ...
  <section id="portfolio" class="portfolio bgBlue">
  ...
  <section id="contact" class="contact bgBlue text-white">
